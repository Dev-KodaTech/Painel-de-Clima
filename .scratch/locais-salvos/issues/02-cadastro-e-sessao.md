...
- [ ] Cadastrar com e-mail e senha cria a conta e devolve o cookie de sessão
- [ ] O endpoint de quem sou identifica a conta quando há sessão válida
- [ ] O endpoint de quem sou responde que não há conta quando não há sessão, sem erro
- [ ] Cadastrar com e-mail já usado é recusado com mensagem clara
- [ ] Dois e-mails que diferem só por maiúsculas são o mesmo e-mail
- [ ] A senha é guardada como hash, e o hash nunca é igual entre duas contas de mesma senha
- [ ] Nenhuma resposta da API contém a senha ou o hash, nem em erro
- [ ] Senha abaixo do mínimo exigido é recusada com mensagem que diz o requisito
- [ ] E-mail malformado é recusado
- [ ] O cookie é `HttpOnly` e `SameSite=Lax`, e `Secure` fora de desenvolvimento
- [ ] Uma sessão expirada é recusada pelo endpoint de quem sou
- [ ] O CORS permite credenciais e os métodos de escrita, com origem explícita
